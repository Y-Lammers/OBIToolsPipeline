...
/global/work/ylammers/OBI/bin/ecotag --skip-on-error -t /global/work/ylammers/Reference/TAXO --fasta -R /global/work/ylammers/Reference/ArctBorBryo/arctborbryo.gh.oligo.clean.fasta $FASTA > ${FASTA/.fasta/.arctborbryo-iden.fasta}
